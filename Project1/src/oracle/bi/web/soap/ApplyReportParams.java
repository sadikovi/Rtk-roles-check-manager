 ...
 *         &lt;element name="encodeInString" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlRootElement(name = "applyReportParams")
public class ApplyReportParams {

    @XmlElement(required = true)
    protected ReportRef reportRef;
    @XmlElement(required = true)
    protected ReportParams reportParams;
    protected boolean encodeInString;
    ...
    /**
     * Gets the value of the encodeInString property.
     * 
     */
    ...
    /**
     * Sets the value of the encodeInString property.
     * 
     */
    public void setEncodeInString(boolean value) {
        this.encodeInString = value;
    }
